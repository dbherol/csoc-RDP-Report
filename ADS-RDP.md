...
* The CCIT Support Center uses RDP to provide remote assistance. The remote host is accessed through a 3rd party software called “Bomgar”. Bomgar uses integrated RDP but bypasses VPN tunneling, port forwarding, and a need to configure the firewall. 
